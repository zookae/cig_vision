...
However, we are not merely advocating that researchers and game developers adopt data-driven analogues to existing Game AI practices (although that would certainly be a worthy endeavor).]
...
We will first describe the shifting landscape of computer game development and the historical precedents behind our desiderata. 
In the course of our desiderata, we will enumerate the new research questions that are arising and steps toward how they may be addressed. 
%We 
...
In 2001, Laird and van Lent \mytodo{cite} put forth their seminal argument for AI in computer games as an academic pursuit. 
...
%
The paradigm of game AI concerned itself with a metaphor of AI as a game designer. 
...
For AI designers the prominent challenges roughly align with Procedural Content Generation (PCG),
...
concerns itself with generating any and all components of games \cite{hendrikx2013:pcg,togelius2011:sbpcg}. 
\mytodo{cite Yannakakis' future of game AI paper?}
%
...
%
As noted, ``Game AI 2.0'' paradigm does not replace the 1.0 paradigm, but compliments it.
...
\subsubsection{How can an NPC interact with players over very long periods?}
...
In the context of games, lifelong agents may foster player empathy for companions---and enmity for rivals---or engaging users in social interactions with game world NPCs. 
...
The key to lifelong agents in games may be algorithms that learn from interactions with individual players. \mytodo{player modeling?}
Additionally, lifelong agents must be able to adapt to new content from patches, expansions, downloadable content, and other incremental updates to the game the agent inhabits.
Research into machine learning for {\em lifelong learning} investigates the transfer of knowledge between particular tasks, continually learning and refining knowledge, uncovering representations for complex information, and incorporating guidance or feedback from humans. 


\subsubsection{How can a game support longitudinal gameplay?}
...
\subsubsection{How does a game generate motivational content?}
% % [needs better name]
...
\subsubsection{How can agents interact with players across games?}
